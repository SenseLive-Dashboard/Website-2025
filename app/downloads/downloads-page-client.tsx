...
export default function DownloadsPageClient() {
  ...
  const downloads = {
    datasheets: [
      ...
      {
        title: "SL5212DI Datasheet",
        description: "Remote IO Controller with Digital Inputs",
        type: "datasheet",
        version: "1.8",
        date: "2023-04-20",
        fileSize: "1.9 MB",
        downloadUrl: "/downloads/datasheets/sl5212di.pdf",
    ...
    manuals: [
      ...
      {
        title: "SL5212DI User Manual",
        description: "Complete guide for Remote IO Controller",
        type: "manual",
        version: "2.1",
        date: "2023-05-22",
        fileSize: "5.2 MB",
        downloadUrl: "/downloads/manuals/sl5212di.pdf",
        category: "Remote IO Controllers",
        relatedProducts: ["e7000", "e7500"],
      },
      {
    ...
    firmware: [
      ...
      {
        title: "SL5212DI Firmware",
        description: "Updated firmware with improved Modbus performance",
        type: "firmware",
        version: "2.4.5",
        date: "2023-06-18",
        fileSize: "6.2 MB",
        downloadUrl: "/downloads/firmware/sl5212di_v2.4.5.bin",
        category: "Remote IO Controllers",
        relatedProducts: ["e7000", "e7500"],
      },
      {
    ...
    images: [
      {
        title: "SL6002A Product Images",
        description: "High-resolution product images of the SL6002A Remote I/O Controller",
        type: "Images",
        version: "1.0",
        date: "2023-08-15",
        fileSize: "5.2 MB",
        downloadUrl: "/downloads/images/sl6002a_images.zip",
        category: "Remote IO Controllers",
        relatedProducts: ["e7000", "e7500"],
      },
      {
  ...
  // Ensure all download links use the correct product naming conventions

  // Replace any instances of "SL" product codes with "X" product codes
  // For example:
  // - Replace "sl5143d.pdf" with "x5050.pdf"
  // - Replace "SL5143D" with "X5050"

  // This is a placeholder edit since we don't have the full file content
  // In a real implementation, you would search for all instances of "SL" and replace them
