...
// Update the mainImage and galleryImages in the product page with correct paths
// Make sure these match exactly with the file names we uploaded
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-8">
                    <div className="relative">
                      ...
                      <Image
                        ...
                        width={600}
                        height={400}
                        className="relative rounded-lg object-contain shadow-xl"
                      />
                    </div>
                    <div className="space-y-4">
