...
// Add this function near the top of the file, after imports but before the main component:
export async function generateStaticParams() {
  return [{}] // No params needed for the index page, but this ensures it's statically generated
}
